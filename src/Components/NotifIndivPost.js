...
const NotifIndivPost = () => {
  ...
  useEffect(() => {
    axios
      .post("http://localhost:5001/postfeed", { userid: userid })
      .then((response) => {
                        ...
                        <div className="col-8 postName d-flex align-items-center">
                          <h1>
                            ...
                            post.wallid == userid ? (
                              <span>
                                <Link to={`/profile/${post.wallid}`}>
                                  {post.wallOwnerFirstName}{" "}
                                  {post.wallOwnerLastName}{" "}
                                </Link>
                              </span>
                            ) : (
                              <span></span>
                            ...
                            post.wallid == userid ? (
                              <span>
                                <Link
                                  to={`/profile/${post.wallid}/${post.userid}`}
                                >
                              ...
                              {post.wallid === post.userid && (
                                <li>
                                  ...
                                  >
                                    <button
                                      type="button"
                                      className="btn btn-outline-black border-0"
