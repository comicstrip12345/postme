...
const RegisterForm = () => {
  ...
  const [errorInvalidUsernameMessage, setErrorInvalidUsernameMessage] =
    useState("");
  const [errorInvalidPasswordMessage, setErrorInvalidPasswordMessage] =
    useState("");
  const [
    errorInvalidConfirmPasswordMessage,
    setErrorInvalidConfirmPasswordMessage,
  ] = useState("");
  ...
  const [errorConfirmPasswordBorderColor, setErrorConfirmPasswordBorderColor] =
    useState("");
  ...
  const [errorConfirmPasswordDisp, setErrorConfirmPasswordDisp] =
    useState(false);
      ...
      <div className="col-12 col-xl-6 signUpForm">
        ...
        <div className="row">
          <div className="col-12 col-xl-9 form-floating mb-3 form">
            <input
              type="text"
              style={{ borderColor: `${errorEmailBorderColor}` }}
              className={`form-control`}
              id="email"
              placeholder="text"
        ...
        <div className="row">
          <div className="col-9 form-floating mb-3 form">
            <input
              type="text"
              style={{ borderColor: `${errorUsernameBorderColor}` }}
              className={`form-control`}
              id="floatingUsername"
              placeholder="text"
        ...
        <div className="row">
          <div className="col-9 form-floating mb-3 form">
            <input
              type="password"
              style={{ borderColor: `${errorPasswordBorderColor}` }}
              className={`form-control`}
              id="floatingPassword"
        ...
        <div className="row">
          <div className="col-9 form-floating mb-3 form">
            <input
              type="password"
              style={{ borderColor: `${errorConfirmPasswordBorderColor}` }}
              className={`form-control`}
